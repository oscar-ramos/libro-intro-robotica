...
# Conceptos Introductorios {#sec-chapter-conceptos-introductorios}
...
traslaciones de un objeto rígido, como se verá más adelante, en el [capítulo -@sec-chapter-pos-or-cuerpos-rigidos].
...
características de este espacio se presentarán con más detalle en la @sec-espacio-configuracion.
...
inamovible, llamado *tierra*, también se considera como un eslabón. Cada
...
anterior, y agrupando términos, se obtiene la *fórmula de Grübler* como:
$$
...
representación de la orientación, la cual será descrita con mayor detalle en el [capítulo -@sec-chapter-pos-or-cuerpos-rigidos] y en el [capítulo -@sec-chapter-parametrizaciones-or]. Si un robot posee partes
